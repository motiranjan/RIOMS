...
namespace RIOMS.WebUI.Controllers
{
    public class KhatasController : Controller
    {
        ...
        //public ViewResult Search(string name,int ricId)
        //{
        //    return View(repository.GetKhataByRt(name,ricId));
        //}
        ...
        //    if (kisam==1)
        //    {
        //        plots = repository.GetMasaPlots(vid).OrderBy(p => Convert.ToInt32(p.PlotNo.Split('/')[0])).ToList();
        //    }
        //    else
        //    {
        //        plots = repository.GetBasaPlots(vid).OrderBy(p => Convert.ToInt32(p.PlotNo.Split('/')[0])).ToList();
        //    }
        //    return View(plots);
        //}

        //public ViewResult KisamWise(int vid,string kisam)
        //{
        //    return View("Kisam", repository.GetKisamWiseArea(vid, kisam).ToList());
        //}
